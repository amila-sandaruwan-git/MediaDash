    ...
    <section id="about" className="py-16 px-4 max-w-6xl mx-auto">
      <div className="text-center mb-12">
        <div className="flex justify-center mb-4">
          <div className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white p-4 rounded-2xl">
      ...
      {/* What is MediaDash - Detailed Description */}
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {supportedSites.map((site) => (
            <div key={site.name} className="bg-white dark:bg-gray-800 rounded-xl p-4 text-center shadow-md hover:shadow-xl transition-shadow hover:scale-105 transform duration-200">
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4">
          And many more... <FaInfinity className="inline ml-1" />
        </p>
      </div>

      {/* Why Choose MediaDash */}
      <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 rounded-2xl p-8 mb-12">
        <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6 text-center">
          Why Choose MediaDash?
        </h3>
